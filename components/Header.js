...
import { restoreHiddenArticles } from '../reducers/hiddenArticles';
...
function Header() {
	...
	const handleRegister = () => {
		fetch('https://morningnews-backend-three.vercel.app/users/signup', {
			method: 'POST',
	...
	const handleConnection = () => {
		...
		fetch('https://morningnews-backend-three.vercel.app/users/signin', {
			method: 'POST',
			headers: { 'Content-Type': 'application/json' },
	...
	const handleEyeClick = () => {
		dispatch(restoreHiddenArticles())
	}
